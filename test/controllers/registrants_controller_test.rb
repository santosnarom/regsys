...
class RegistrantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registrant" do
    assert_difference('Registrant.count') do
      post registrants_url, params: { registrant: { batch: @registrant.batch, contactno: @registrant.contactno, course: @registrant.course, email: @registrant.email, firstname: @registrant.firstname, lastname: @registrant.lastname, referral: @registrant.referral } }
    end
  ...
  test "should update registrant" do
    patch registrant_url(@registrant), params: { registrant: { batch: @registrant.batch, contactno: @registrant.contactno, course: @registrant.course, email: @registrant.email, firstname: @registrant.firstname, lastname: @registrant.lastname, referral: @registrant.referral } }
